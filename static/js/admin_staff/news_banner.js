$(function () {
    ...
    function closeBanner(bannerItem) {
        ...
        $closeBtn.click(function () {
            ...
            ALERT.alertConfirm({
                ...
                "confirmText": "确认",
                "confirmCallback": () => {
                    selfAjax("/admin/news_banner/", 'delete', {"banner_id": bannerId}, res => {
                        if (res["code"] === 1) {
    ...
    function saveBanner(bannerItem) {
      ...
      `);
            ...
            selfAjax("/admin/news_banner/", method, data, res => {
                if (res["code"] === 1) {
                    if (bannerId) {
    ...
    function createBannerItem(banner) {
        ...
        <div class="box-body">
          <div class="pull-left banner-img">
            <input type="file" name="banner-image-select" style="display: none;">
            <img src="/static/img/banner_default.png" class="img-thumbnail banner-image">
          </div>
          <div class="pull-left banner-info">
            <div class="form-group">
